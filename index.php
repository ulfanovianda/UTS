    ...
    <div class="content-wrapper">
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/gambar/a1.jpg" alt="First slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/a2.jpg" alt="Second slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/a3.jpg" alt="Third slide" height="450">
                      </div>
                    </div>
      ...
      <footer class="main-footer">
        ...
        <div class="float-right d-none d-sm-inline">
          Muhammad Fiqar Ramadhan
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Universitas Teknologi Sumbawa</a>.</strong> All rights reserved.
      </footer>
    </div>
    <!-- ./wrapper -->
